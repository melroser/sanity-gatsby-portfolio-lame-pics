# sanity-gatsby-portfolio-lame-pics
...
1. Go to your [project’s API settings on manage.sanity.io](https://manage.sanity.io/projects/li8brw29/settings/api) and create a token with read rights.
